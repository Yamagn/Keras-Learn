...
class Trainer():
    ...
    def train(self, x_train, y_train, batch_size, epochs, validation_split):
        ...
        self._target.fit(x_train, y_train, batch_size=batch_size, epochs=epochs, validation_split=validation_split, callbacks=[TensorBoard(log_dir=self.log_dir)], verbose=self.verbose)
